...
def _write_cg_summary_table(sheet, h1_profit, h1_loss, h1_sell, h2_profit, h2_loss, h2_sell):
    ...
    rows = [
        ...
        (6,  'רווח מחצית ראשונה (קוד 13)',            round_half_up(h1_profit),                                      H1_FILL,    DATA_FONT),
        ...
        (9,  'רווח מחצית שנייה (קוד 13)',             round_half_up(h2_profit),                                      H2_FILL,    DATA_FONT),
        (10, 'הפסד מחצית שנייה (קוד 33)',             round_half_up(abs(h2_loss)),                                   H2_FILL,    DATA_FONT),
        (11, 'סכום מכירות מחצית שנייה (קוד 56)',      round_half_up(h2_sell),                                        H2_FILL,    DATA_FONT),
